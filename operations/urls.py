...
urlpatterns = [
    ...
    path('vendas/<int:pk>/apagar/', views.SaleDeleteView.as_view(), name='sale_delete'),
    ...
    path('utilizadores/<int:pk>/password/', views.UserPasswordUpdateView.as_view(), name='user_password'),
]
